...
import type { BootstrapCompilationInput, BootstrapPlan, BootstrapStep } from "./types";
...
export async function compileBootstrapPlan(
  input: BootstrapCompilationInput,
...
function compileSteps(input: BootstrapCompilationInput): BootstrapStep[] {
