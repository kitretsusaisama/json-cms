...
export type HookName = "page:before-resolve" | "page:after-resolve" | "page:before-plan" | "page:after-plan" | "page:before-render" | "component:before-render" | "component:after-render" | "cms:request" | "cms:response" | "settings:save" | "plugin:activate" | "plugin:deactivate" | string;
...
export interface PluginLifecycle {
     ...
     */
    onUpgrade?(ctx: PluginInstallContext, previousVersion: string): Promise<void>;
    /**
...
export interface SdkRegistry {
    registerComponent(key: string, component: React.ComponentType<Record<string, unknown>>, meta?: Partial<PluginComponentDef>): void;
    registerHook(hookName: HookName, handler: (data: unknown) => Promise<unknown> | unknown, priority?: number): () => void;
    registerContentType(type: ContentTypeDefinition): void;
    registerRenderer(schemaType: string, options: {
        componentKey?: string;
        renderer?: unknown;
        priority?: number;
