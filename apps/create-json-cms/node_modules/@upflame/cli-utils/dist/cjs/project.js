...
exports.renderCmsConfig = renderCmsConfig;
...
function buildProjectManifest(options) {
    const preset = (0, presets_1.getPresetDefinition)(options.preset);
    return {
...
function renderCmsConfig(presetId, pluginPackages, framework = "nextjs") {
    const preset = (0, presets_1.getPresetDefinition)(presetId);
